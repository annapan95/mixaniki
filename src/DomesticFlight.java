...
public class DomesticFlight extends JFrame
{
	...
	public DomesticFlight(LoginPage type1)
	{
		...
		String[] sItem1={"Athens"};
		String[] sItem2 ={ "Thessaloniki", "Ioannina ", "Corfu", "Kefalonia", "Alexandroupoli" };
		...
		LNotes = new JLabel("<html><body><p>NOTE: Bookings with Credit Cards <p> have temporarily been suspended.This Service<p> will resume shortly and we will have a notice<p> posted on our website.We regret any <p>inconvenience caused to our passengers.</body></html>");
