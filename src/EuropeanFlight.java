...
import java.sql.*;
import java.sql.*;
public class EuropeanFlight extends JFrame
{
	...
	public EuropeanFlight(LoginPage type1)
	{
		Container c =getContentPane();
		c.setLayout(new BorderLayout());
		String[] sItem1={"Athens"};
		String[] sItem2={"Nicosia","Pafo","Instabul","Rome","Milan","Paris","Naples","Berlin","London","Barcelona","Madrid","Vienna","Munich","Paris","Rome"};
...
class button2 implements ActionListener
{
	EuropeanFlight type;
	LoginPage type1;
	button2(EuropeanFlight type, LoginPage type1)
	{
		this.type = type;
		this.type1 = type1;
	}
