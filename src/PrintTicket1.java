...
public class PrintTicket1 extends JFrame
{
	public PrintTicket1(String sFrom, String sTo, String sClass, Integer iAdult, Integer iChildren, Integer iInfant, String sBookingDate, Integer iPrice, String sTime)
	{
		...
		JLabel LTasos=new JLabel("<html><I><font color=\"#8FBC8F\">Tasos Alexiou</font></I></html>");
		JLabel LDemos=new JLabel("<html><I><font color=\"#8FBC8F\">Demos Tokas</font></I></html>");
		JLabel LAnna=new JLabel("<html><I><font color=\"#8FBC8F\">Anna Panagiotaki</font></I></html>");
		...
		LTasos.setBounds(285,485,300,20);
		LDemos.setBounds(285,505,300,20);
		LAnna.setBounds(285,525,300,20);
